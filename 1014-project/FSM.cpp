...
void TitleState::Enter(){
	...
	// Load the background
	bgSurf = IMG_Load("img/titlebg.gif");
	bgText = SDL_CreateTextureFromSurface(Game::Instance()->GetRenderer(), bgSurf);

	// Load the buttons
	m_vButtons.push_back(new Button("img/new-game.png", { 412,400,200,60 }));
	m_vButtons.push_back(new Button("img/exit.png", { 451,600,122,60 }));
  m_vButtons.push_back(new Button("img/score-board.png", { 405,500,214,60 }));

	// Load and play menu music
	Game::Instance()->GetAM()->LoadMusic("aud/menuTheme.mp3");
...
void GameState::Enter(){
	...
	Game::Instance()->GetAM()->LoadMusic("aud/gameTheme.mp3");
...
void LoseState::Enter(){
	...
	// Load button
	lButtons.push_back(new Button("img/main-menu.png", { 312,450,205,60 }));
