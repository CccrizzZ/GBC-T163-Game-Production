...
void LoseState::Enter(){
	...
	// Final score
	LFont = TTF_OpenFont("img/scorebFont.ttf", 20);
	string fin = to_string(temp).c_str();
	string fin2 = "Your final score is: " + fin;
	LostSurf = TTF_RenderText_Solid( LFont,  fin2.c_str(), FinalScoreColor );
